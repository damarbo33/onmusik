...
Transcode::Transcode(const Transcode& orig) {
}

Transcode::~Transcode() {
}

char *Transcode::av_cplus_make_error_string(char *errbuf, size_t errbuf_size, int errnum)
{
    av_strerror(errnum, errbuf, errbuf_size);
    return errbuf;
}

char *Transcode::av_cplus_err2str(int errnum){
    memset(buffErrors, '\0', AV_ERROR_MAX_STRING_SIZE);
 ...
 * @return Error code (0 if successful)
 */
int Transcode::init_fifo(AVAudioFifo **fifo, AVCodecContext *output_codec_context)
{
 ...
 * @return Error code (0 if successful)
 */
int Transcode::write_output_file_header(AVFormatContext *output_format_context)
{
    int error;
 ...
 * @return Error code (0 if successful)
 */
int Transcode::write_output_file_trailer(AVFormatContext *output_format_context)
{
    int error;
...
void Transcode::setAudio_dst(AudioParams audio_dst) {
    this->audio_dst = audio_dst;
}

AudioParams Transcode::getAudio_dst() const {
    return audio_dst;
}
 ...
 * @return 
 */
TID3Tags Transcode::getSongInfo(string filepath){
    TID3Tags songTags;
